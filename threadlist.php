...
<body>
    ...
    if ($method == 'POST') {
        ...
        $sql = "INSERT INTO `threads` (`thread_title`, `thread_desc`, `thread_cat_id`, `thread_user_id`, `timestamp`) VALUES ('$th_title', '$th_desc', '$id', '$sno', 
        current_timestamp())";
        $result = mysqli_query($conn, $sql);
        $showAlert = true;
        if ($showAlert) {
            echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
            <strong>Success!</strong> Your Thread has been added! Please wait for comunity respond
    ...
    <div class="container my-4 question">
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            <p class="fw-bold my-0">' . $row2['usname'] . '</p><p>' . $thread_time . '</p>
